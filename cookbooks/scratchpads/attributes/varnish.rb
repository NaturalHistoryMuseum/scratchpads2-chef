...
default['scratchpads']['varnish']['search']['domains'] = ['sp-control-1.nhm.ac.uk']
...
default['scratchpads']['varnish']['control']['domains'] = [node['scratchpads']['control']['aegir_url']]
default['scratchpads']['varnish']['sp_app_server_port'] = 80
default['scratchpads']['varnish']['trusted_networks'] = ['"157.140.0.0"/16','"127.0.0.0"/16']
default['scratchpads']['varnish']['no_cache_domains'] = ['zooemu.nhm.ac.uk','edit.nhm.ac.uk','sandbox.scratchpads.eu']
