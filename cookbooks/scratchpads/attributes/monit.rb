...
default['scratchpads']['monit']['conf']['varnish']['roles'] = [node['scratchpads']['control']['role']]
...
default['scratchpads']['monit']['conf']['postfix']['roles'] = [node['scratchpads']['ntp']['role']]
...
default['scratchpads']['monit']['conf']['sandbox']['roles'] = [node['scratchpads']['control']['role']]
...
default['scratchpads']['monit']['conf']['mysql']['roles'] = [node['scratchpads']['percona']['role']]
...
default['scratchpads']['monit']['conf']['memcached']['roles'] = [node['scratchpads']['data']['role']]
...
default['scratchpads']['monit']['conf'][node['fqdn']]['roles'] = [node['scratchpads']['ntp']['role']] # ~FC047
...
default['scratchpads']['monit']['conf']['var-partition']['roles'] = [node['scratchpads']['control']['role']]
...
default['scratchpads']['monit']['conf']['50gb-root-partition']['roles'] = [node['scratchpads']['apache']['role']]
...
default['scratchpads']['monit']['conf']['100gb-root-partition']['roles'] = [node['scratchpads']['data']['role'],node['scratchpads']['search']['role']]
...
default['scratchpads']['monit']['conf']['boot-partition']['roles'] = [node['scratchpads']['ntp']['role']]
